...
if ($_SERVER["REQUEST_METHOD"] == "POST") { 
    ...
    $stmt = $conn->prepare("SELECT email, pass, UserType FROM login WHERE email = ?");
    ...
    if ($result->num_rows == 1) { 
        ...
        if ($password == $row['pass']) { 
            ...
            $_SESSION['UserType'] = strtolower($row['UserType']); // Store user type in session
...
<body>
    <div class="login-container">
        ...
        <form method="POST">
            ...
            <!-- Actions -->
            <div class="actions">
                <div class="login-link"><a href="#">Forgot password?</a>
                </div>
            </div>
